...
def levenshtein_distance(s, t):
    ...
    # Initialiser la première ligne de la matrice
    for i in range(m + 1):
        d[i][0] = i

    # Initialiser la première colonne de la matrice
    for j in range(n + 1):
        d[0][j] = j

    # Remplir la matrice en utilisant la méthode récursive de Levenshtein
